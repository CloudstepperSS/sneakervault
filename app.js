...
document.getElementById('auth-toggle').addEventListener('click', () => {
  ...
  $('auth-toggle').textContent = isSignup ? 'Sign in instead' : 'Create account';
  $('auth-toggle-label').textContent = isSignup ? 'Already have an account?' : 'No account yet?';
